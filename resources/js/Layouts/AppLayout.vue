            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <JetNavLink :href="route('dashboard')" :active="route().current('dashboard')" hidden>
                                    Dashboard
                                </JetNavLink>
                                <JetNavLink :href="route('MyMessages')" :active="route().current('MyMessages')">
                                    My Messages
                                </JetNavLink>
                               
                                <JetNavLink :href="route('ContactList')" :active="route().current('ContactList')">
                                    Contact List
                                </JetNavLink>
                            ...
                            <div class="ml-3 relative">
                                <JetDropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <JetDropdownLink :href="route('PrivateCodeManager')">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetResponsiveNavLink :href="route('dashboard')" :active="route().current('dashboard')" hidden>
                            Dashboard
                        </JetResponsiveNavLink>
                        <JetResponsiveNavLink :href="route('MyMessages')" :active="route().current('MyMessages')">
                            My Messages
                        </JetResponsiveNavLink>
                        
                        <JetResponsiveNavLink :href="route('ContactList')" :active="route().current('ContactList')">
                            Contact List
                        </JetResponsiveNavLink>
                    </div>
